function validateSubsForm() {
    ...
    resetErrors([nameInput, adresInput, regionInput], [errorFloristName, errorClientName, errorRegio, errorClientName, errorClientName, errorClientName, errorClientName], errorsSummary);
