function validateSubsForm() {
    ...
    console.log("1 ", floristName.value);
    console.log("2 ", clientName.value);
    console.log("3 ",Value.value);
    console.log("4 ", Information.value);
    console.log("5 ", dateFrom.value);
    ...
    } else if (!checkNumberRange(Value.value, 10, 10000)) {
        valid = false;
        Value.classList.add("error-input");
    ...
    } else if (checkDateIfAfter(nowString, dateFrom.value)) {
        valid = false;
        dateFrom.classList.add("error-input");
    ...
    if (!checkRequired(dateTo.value)) {
        ...
        valid = false;
        dateTo.classList.add("error-input");
        errorDateTo.innerText = "Pole powinno zawierać datę w formacie yyyy-MM-dd (np. 2000-01-01)";
    } else if (checkDateIfAfter(nowString, dateTo.value)) {
        valid = false;
        dateTo.classList.add("error-input");
