function validateFloristForm() {
    ...
    if (!checkRequired(regionInput.value)) {
        console.log('checkRequired(regionInput.value):', checkRequired(regionInput.value));
        valid = false;
        ...
        valid = false;
        regionInput.classList.add("error-input");
        errorEmail.innerText = "Pole powinno zawierać prawidłowy numer";
    } else if (!checkNumberRange(regionInput.value, 2, 6)) {
        valid = false;
        regionInput.classList.add("error-input");
        errorEmail.innerText = "Pole powinno zawierać od 2 do 6 znaków";
    }
