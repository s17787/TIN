function validateSubsForm() {
    ...
    if (!checkRequired(Information.value)) {
        valid = false;
        Information.classList.add("error-input");
        errorAdres.innerText = "Pole jest wymagane";
    } else if (!checkTextLengthRange(Information.value, 5, 100)) {
        valid = false;
        Information.classList.add("error-input");
        errorAdres.innerText = "Pole powinno zawierać od 2 do 100 znaków";
